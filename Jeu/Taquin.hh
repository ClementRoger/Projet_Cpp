...
class Taquin : public MiniJeu{
 ...
 public:
  ...
  bool check_move(const int number); // Renvoie true si on peut bouger la case, false sinon
  ...
  int get_image_number(const int x, const int y); //Renvoie le numéro de l'image (l'index du vecteur) sur laquelle l'utilisateur a cliquée
